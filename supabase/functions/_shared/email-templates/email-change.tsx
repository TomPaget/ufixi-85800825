...
export const EmailChangeEmail = ({ siteName, email, newEmail, confirmationUrl, name }: EmailChangeEmailProps) => (
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={contentSection}>
          <Heading style={h1}>
            {name ? <><span style={gradientName}>{name}</span>, confirm your email change</> : 'Confirm your email change'}
          </Heading>
          <Text style={text}>
