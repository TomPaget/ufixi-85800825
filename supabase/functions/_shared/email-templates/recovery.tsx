...
export const RecoveryEmail = ({ siteName, confirmationUrl, name }: RecoveryEmailProps) => (
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={contentSection}>
          <Heading style={h1}>
            {name ? <><span style={gradientName}>{name}</span>, reset your password</> : 'Reset your password'}
          </Heading>
          <Text style={text}>
