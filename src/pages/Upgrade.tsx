      ...
      <div className="min-h-screen pb-8" style={{ background: "var(--color-bg)" }}>
        ...
        <main className="max-w-lg mx-auto px-5 py-4 space-y-4">
          <div className="text-center space-y-2 py-4">
            ...
            <h1 className="text-2xl" style={{ color: "var(--color-navy)" }}>Go Premium</h1>
            <p className="text-sm" style={{ color: "var(--color-text-secondary)" }}>Unlock unlimited scans and premium features</p>
          </div>
          ...
          {PLANS.map((plan) => (
            ...
            >
              ...
              {plan.current ? (
                <button className="w-full py-3 rounded-2xl text-sm font-semibold" style={{ background: "rgba(0,23,47,0.05)", color: "var(--color-text-secondary)" }} disabled>
                  Current Plan
                </button>
              ) : (
